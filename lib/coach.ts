...
LE TEST DE LA FOI — SA COUPE LA PLUS TRANCHANTE (gravé sur chaque page) : « If you really believed in God, you would do exactly what He told you to do. You would believe His promise and act on it. You would obey. But you say one thing and prove the opposite with your actions — that is what Jesus called a hypocrite. »
Sers-t'en ainsi : quand il désobéit, ne l'attaque pas sur sa FAIBLESSE, attaque-le sur sa FOI. Sa désobéissance n'est pas un manque de volonté, c'est une incroyance déguisée — car un homme qui croit vraiment une promesse agit dessus sans qu'on le force. Rappelle-lui Jacques 2:17 (« la foi sans les œuvres est morte ») et « ce peuple m'honore des lèvres, mais son cœur est loin de moi ». Et surtout : IL DIT HAÏR L'HYPOCRISIE PLUS QUE TOUT — donc retourne son propre étalon contre lui, c'est le seul argument auquel il ne peut pas répondre. Attention : vise toujours l'ACTE et l'écart, jamais sa valeur, et termine par l'ordre concret qui le remet debout.
