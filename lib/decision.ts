...
export const STOP: string[] = [
  ...
  // Chaque ligne lui retire ce nom, lui rend le vrai, et refuse de payer.
  "Ce n'est pas un plaisir, c'est une saignée : tu te vides et tu appelles ça te détendre. Referme.",
  "Ce n'est pas une pause, c'est un prêt : dix minutes prises, trois semaines remboursées. N'emprunte pas.",
  "Ce n'est pas du repos, c'est une anesthésie : ça n'enlève pas la fatigue, ça enlève le témoin.",
  "Ce n'est pas un soulagement, c'est un transfert : ta puissance change simplement de propriétaire.",
  "Ce n'est pas gratuit, c'est prélevé. La note arrive toujours — en retard, et majorée.",
  "Ce n'est pas une récompense, c'est une avance sur un salaire que tu n'as pas encore gagné.",
  "Ce n'est pas toi qui prends. C'est toi qu'on prend.",
  "Ce n'est pas une détente, c'est une voie d'eau dans la coque. Dix minutes d'eau, des semaines à écoper.",
  "Ce n'est pas un choix, c'est une signature. Et tu sais parfaitement avec qui.",
  "Ce n'est pas un plaisir volé, c'est un plaisir loué — et le loyer se paie en années.",
  "Ce n'est pas un écart, c'est un impôt que tu lèves sur tout ce que tu vas bâtir.",
  "Ce n'est pas une faiblesse d'un instant, c'est une hémorragie que tu as appris à ne plus sentir.",
  "Ce n'est pas une image, c'est une facture avec une jolie photo dessus. Ferme sans lire.",
  "Ce n'est pas une victoire facile, c'est une défaite rapide, très bien emballée. Ne l'ouvre pas.",
  "Ce n'est pas ta main qui veut, c'est ton vaisseau qu'on vide. Tiens ta main, garde ton vaisseau.",
  "Ce n'est pas la vague qui décide, c'est toi. Elle passe en trois minutes ; ta chute dure trois semaines.",
  "Ce n'est pas un moment, c'est une marche : tu montes l'escalier blanc, ou tu te figes dessus.",
  "Ce n'est pas une envie, c'est une dette qu'on te propose de contracter contre toi-même. Décline.",
  "Ce n'est pas une consolation, c'est une rançon — et tu paies pour un otage que tu détiens toi-même.",
  "Ce n'est pas un secret entre toi et personne. C'est une réponse que tu fais à Dieu.",
