...
export default async function ProgressionPage() {
  ...
  return (
    <main className="px-4 pt-6 md:mx-auto md:max-w-3xl xl:max-w-none">
      ...
      <div className="xl:grid xl:grid-cols-2 xl:items-start xl:gap-3 2xl:grid-cols-3">
        <div
          className="mb-5 flex items-center justify-between rounded-xl border p-4 xl:mb-0"
